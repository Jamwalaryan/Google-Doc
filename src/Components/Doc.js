  ...
  return (
    <div className="header">
      <div className="whiteBar">
        ...
        <div class="toolBar">
          <div class="toolBag"></div>
          <img
            class="toolbarButtonsPrint"
